...
class AlbumViewHolder(private val itemBinding: AlbumViewBinding) :
    ...
    fun bind(albumItem: AlbumDTO, recyclerItemListener: RecyclerItemListener) {
        ...
        Picasso.get().load(albumItem.coverImageUrl).placeholder(R.drawable.ic_placeholder)
            .error(R.drawable.ic_error_placholder).into(itemBinding.ivAlbumCover)
